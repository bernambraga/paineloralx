            ...
            <div key={link.name} className={classes.menuItem}>
              ...
              {link.sublinks && openMenu === link.name && (
                <div className={classes.sublinksContainer}>
                  {link.sublinks.filter((sublink) => hasPermission(sublink.allowedGroups)).map((sublink) => (
                    <NavLink
                      key={sublink.name}
                      to={sublink.to}
                      className={({ isActive }) =>
